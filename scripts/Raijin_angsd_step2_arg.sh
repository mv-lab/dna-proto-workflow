...
#PBS -P xe2
#PBS -q normal
#PBS -l ncpus=1,walltime=150:00:00,mem=80GB
#PBS -l wd
...
# usage:
# echo "/g/data1/xe2/projects/euc_hybrid_adapt/workspace/scripts/Raijin_angsd_step2_arg.sh -s albens -c Chr01"|qsub -N alb.01.saf -P xe2 -l jobfs=1GB,ncpus=1,mem=2G,walltime=2:00:00
...
angsd -P 1 -bam $BAMLIST -out $OUT -ref $REF -anc $ANC -GL 2 -doMajorMinor 5 -doMaf 1 -doSaf 1 -C 50 -baq 1 -minMapQ 30 -minQ 20 -r $CHR -sites $SITES > $OUT.log
